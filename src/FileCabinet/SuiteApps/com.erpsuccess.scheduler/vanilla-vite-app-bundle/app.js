(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const t of o.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&r(t)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const h=decodeURIComponent($("#suiteletUrl").val()),C=JSON.parse(decodeURIComponent($("#workOrders").val())),H=JSON.parse(decodeURIComponent($("#customers").val())),y=JSON.parse(decodeURIComponent($("#resources").val())),B=JSON.parse(decodeURIComponent($("#resourceGroups").val())),k=JSON.parse(decodeURIComponent($("#events").val()));function q(l){const e=$("#leftSidebar select.selectpicker");let a=[],r=[],n=[];e.on("change",function(){const o=$(this).val()||[],t=$(this).parent().attr("class").split(" ").find(d=>d.match(/multiple-/gi)),i={};switch(t){case"multiple-resource-field":a=o;break;case"multiple-resource-group-field":r=o;break;case"multiple-status-field":n=o;break}$("#leftSidebar .collapsible-list .person-container").each(function(){const d=$(this),v=d.closest('div[id*="-filter-tableWrapper"]').attr("id").match(/\d+/)[0];i[v]||(i[v]=0);let m=!1,b;a.length&&(m=a.includes(d.attr("id"))),m&&r.length&&(b=l.all.find(c=>c.employee.value==d.attr("id")),b&&(m=r.includes(b.resourceGroup.value))),m&&n.length&&(b=l.all.find(c=>c.employee.value==d.attr("id")),b&&(n.includes("1")?m=!!b.active:n.includes("2")?m=!b.active:m=!0)),!a.length&&!r.length&&!n.length&&(m=!0),d.toggle(m),m&&i[v]++}),$.each(i,function(d,u){$(`#leftSidebar #resourceGroup-${d}-filter-tableWrapper span.counter`).html(u)});const p=Object.values(i).reduce((d,u)=>d+u,0);$("#leftSidebar .card-header span.counter").html(p)})}function V(l){const e=$("#secondColumn .card-wrapper .card-item"),a=$("#secondColumn input#job-datefrom"),r=$("#secondColumn input#job-dateto"),n=$("#secondColumn select.multiple-customer-field"),o=$("#secondColumn input#woTitle"),t={dateFrom:"",dateTo:"",customers:[],woTitle:""};a.length&&a.on("change",function(){t.dateFrom=$(this).val()||[],i()}),r.length&&r.on("change",function(){t.dateTo=$(this).val()||[],i()}),n.length&&n.on("change",function(){t.customers=$(this).val()||[],i()}),o.length&&o.on("keyup",function(){t.woTitle=$(this).val(),i()});function i(){e.each(function(){const p=$(this),d=p[0].id,u=l.find(v=>v.id==d);if(u){let v=u.date;const m=u.customer.value,b=u.title,c=new RegExp(t.woTitle,"gi");let g=!1;v&&(v=moment(v),t.dateFrom=t.dateFrom?moment(t.dateFrom):"",t.dateTo=t.dateTo?moment(t.dateTo):"",t.dateFrom&&t.dateTo?g=v.isBetween(t.dateFrom,t.dateTo,null,"[]"):t.dateFrom&&!t.dateTo?g=v.isSameOrAfter(t.dateFrom):!t.dateFrom&&t.dateTo&&(g=v.isSameOrBefore(t.dateTo))),!t.dateFrom&&!t.dateTo&&(g=!0);const O=!!(g&&(!t.customers.length||t.customers.includes(m))&&b.match(c));p.toggle(O)}}),s()}function s(){const p=e.filter(function(){return $(this).css("display")!=="none"}).length;$("#secondColumn .card-header span.counter").html(p)}}function U(l){const e=$("#thirdColumn .card-wrapper .card-item"),a=$("#thirdColumn input#event-datefrom"),r=$("#thirdColumn input#event-dateto"),n=$("#thirdColumn select.multiple-resource-field"),o=$("#thirdColumn select.multiple-resource-group-field"),t=$("#thirdColumn select.multiple-event-status-field"),i=$("#thirdColumn select.multiple-event-priority-field"),s={dateFrom:"",dateTo:"",resources:[],resourceGroups:[],status:[],priority:[]};a.length&&a.on("change",function(){s.dateFrom=$(this).val()||[],p()}),r.length&&r.on("change",function(){s.dateTo=$(this).val()||[],p()}),n.length&&n.on("change",function(){s.resources=$(this).val()||[],p()}),o.length&&o.on("change",function(){s.resourceGroups=$(this).val()||[],p()}),t.length&&t.on("change",function(){s.status=$(this).val()||[],p()}),i.length&&i.on("change",function(){s.priority=$(this).val()||[],p()});function p(){e.each(function(){const u=$(this),v=u[0].id,m=l.find(b=>b.id==v);if(m){let b=m.date.end||m.date.start;const c=m.resources.map(x=>x.employee.value),g=m.resources.map(x=>x.resourceGroup.value),O=m.status.value,j=m.priority.value;let w=!1;b&&(b=moment(b),s.dateFrom=s.dateFrom?moment(s.dateFrom):"",s.dateTo=s.dateTo?moment(s.dateTo):"",s.dateFrom&&s.dateTo?w=b.isBetween(s.dateFrom,s.dateTo,null,"[]"):s.dateFrom&&!s.dateTo?w=b.isSameOrAfter(s.dateFrom):!s.dateFrom&&s.dateTo&&(w=b.isSameOrBefore(s.dateTo))),!s.dateFrom&&!s.dateTo&&(w=!0);const L=!!(w&&(!s.resources.length||s.resources.some(x=>new Set(c).has(x)))&&(!s.resourceGroups.length||s.resourceGroups.some(x=>new Set(g).has(x)))&&(!s.status.length||s.status.includes(O))&&(!s.priority.length||s.priority.includes(j)));u.toggle(L)}}),d()}function d(){const u=e.filter(function(){return $(this).css("display")!=="none"}).length;$("#thirdColumn .card-header span.counter").html(u)}}const _=[{className:"dt-head-center dr-body-center",title:`<div class="form-group form-check container d-flex justify-content-center">
              ...
              <div class="content">
                <div class="card-header header">
                  <div style="text-align: center;">
                    ...
                    <span class="badge badge-danger badge-pill counter">${k.length}</span>
                  </div>
                </div>
