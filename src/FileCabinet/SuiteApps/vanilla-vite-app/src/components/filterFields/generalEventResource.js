import { onFilterGeneralEventResource } from './filterUtils';
...
$(document).ready(() => {
          ...
          <form class="selectFiltersForm">
            <div class="row mb-3 justify-content-start align-items-center">
              ...
              <div class="col-md-5 d-flex justify-content-end">
                <button type="submit" class="btn btn-primary me-2" onclick="selectFilters(event, 'generalEventResource', '${modalId}')">Save</button>
  ...
  $(modalId).on('shown.bs.modal', () => {
    ...
    onFilterGeneralEventResource(modalId);
