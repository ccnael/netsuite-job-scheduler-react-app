...
import { onFilterGeneralEventResource, clearFilters } from './filterUtils';
import './filterField.css';

$(document).ready(() => {
  $('#app').append(`
    <div class="modal" id="filterFieldGeneralEventResource" mode="" title="" tabindex="-1" style="z-index: -999">
