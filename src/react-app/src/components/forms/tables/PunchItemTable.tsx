  ...
  const columns: ColumnDef<PunchItem>[] = useMemo(() => [
    {
      ...
      cell: ({ row }) => (
        <div className="text-slate-900 text-[12px] font-sans tracking-tight">{row.getValue("enteredBy")}</div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-slate-900 text-[12px] font-sans tracking-tight">{row.original.status.text}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-slate-700 font-sans tracking-tight text-[12px]">{row.getValue("reason")}</div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-slate-700 font-sans tracking-tight text-[12px]">{row.getValue("resolution")}</div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-slate-700 font-sans tracking-tight text-[12px]">{row.getValue("dateCreated")}</div>
      ),
    },
  ], [renderSortIcon]);
              ...
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className={`border-b border-slate-100 hover:bg-slate-50/50 ${
                    row.original.status?.value != 6 ? 'bg-red-50' : ''
                  }`}
                >
